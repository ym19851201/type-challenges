...
type ExtractAll<T> = T extends readonly [infer Head, ...infer Rest]
  ? [Extract<Head>, ...ExtractAll<Rest>]
  : [];
declare function PromiseAll<T extends any[]>(values: readonly [...T]): Promise<ExtractAll<T>>
