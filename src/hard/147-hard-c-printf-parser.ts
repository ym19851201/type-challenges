...
type ParsePrintFormat<S extends string> = S extends `${infer L}%${infer RHead}${infer R}`
  ? RHead extends keyof ControlsMap
  ? [ControlsMap[RHead], ...ParsePrintFormat<R>] : [...ParsePrintFormat<R>]
  : []
